...
Browser("Login -").Navigate "https://integration-branch-prod.almoctane.com/ui/?admin&p=21001/5001#/settings/workspace/users"
...
Browser("Login -").Page("Workspaces - Core Software").Sync
Browser("Login -").Navigate "https://integration-branch-prod.almoctane.com/ui/?p=21001/5001#/mbt-designer/hierarchy/models" @@ hightlight id_;_269054_;_script infofile_;_ZIP::ssf47.xml_;_
