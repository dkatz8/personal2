Browser("creationtime:=0").Navigate "https://qa3.almoctane.com/ui/?site&p=1001/1002#/experiments"
...
Browser("creationtime:=0").Navigate "https://qa3.almoctane.com/ui/?site=#/site-admin/site-params"
AIUtil.SetContext Browser("Login -")
